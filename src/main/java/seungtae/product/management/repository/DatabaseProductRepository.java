package seungtae.product.management.repository;
...
public class DatabaseProductRepository {
    ...
    public Product add(Product product) {
        ...
        namedParameterJdbcTemplate
                .update("INSERT INTO products (name, price, quantity) VALUES (:name, :price, :quantity)", namedParameter, keyHolder);
    ...
    public Product update(Product product) {
        ...
        namedParameterJdbcTemplate.update("UPDATE products SET name=:name, price=:price, quantity=:quantity WHERE id=:id", namedParameter);
